...
HANGER_DEPTH = 80;
HANGER_WIDTH = 160;
HANGER_WALL_MOUNT_HEIGHT = 120;
HANGER_PLATFORM_LENGTH = 80;
HANGER_INNER_CORNER_RADIUS = 10;

SCREW_HOLE_DIAMETER = 5;
SCREW_HOLE_DEPTH = HANGER_THICKNESS + 1; 
SCREW_HEAD_RECESS_DIAMETER = 10;
SCREW_HEAD_RECESS_DEPTH = 5;

SCREW_HOLE_TOP_BOTTOM_EDGE_MARGIN = 16;
SCREW_HOLE_LEFT_RIGHT_EDGE_MARGIN = 25;
...
function hangerProfile() = [
    ...
    [HANGER_THICKNESS, HANGER_THICKNESS, HANGER_INNER_CORNER_RADIUS],
...
module screwHoleShape() {
    union() {
        ...
        translate([0, 0, -SCREW_HOLE_DEPTH/2 + SCREW_HEAD_RECESS_DEPTH/2])
            cylinder(h = SCREW_HEAD_RECESS_DEPTH, r1 = SCREW_HEAD_RECESS_DIAMETER/2, r2 = SCREW_HOLE_DIAMETER/2, center = true, $fn = 32);
    }
}
...
difference() {
    ...
    translate([HANGER_THICKNESS/2, HANGER_WALL_MOUNT_HEIGHT - SCREW_HOLE_TOP_BOTTOM_EDGE_MARGIN, HANGER_DEPTH - SCREW_HOLE_LEFT_RIGHT_EDGE_MARGIN])
        rotate([0, 270, 0]) 
            screwHoleShape();
    translate([HANGER_THICKNESS/2, HANGER_WALL_MOUNT_HEIGHT - SCREW_HOLE_TOP_BOTTOM_EDGE_MARGIN*4, HANGER_DEPTH - SCREW_HOLE_LEFT_RIGHT_EDGE_MARGIN])
        rotate([0, 270, 0]) 
            screwHoleShape();
    translate([HANGER_THICKNESS/2, HANGER_WALL_MOUNT_HEIGHT - SCREW_HOLE_TOP_BOTTOM_EDGE_MARGIN, SCREW_HOLE_LEFT_RIGHT_EDGE_MARGIN])
        rotate([0, 270, 0]) 
            screwHoleShape();
    translate([HANGER_THICKNESS/2, HANGER_WALL_MOUNT_HEIGHT - SCREW_HOLE_TOP_BOTTOM_EDGE_MARGIN*4, SCREW_HOLE_LEFT_RIGHT_EDGE_MARGIN])
        rotate([0, 270, 0]) 
            screwHoleShape();
}
